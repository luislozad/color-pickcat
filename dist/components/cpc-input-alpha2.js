...
import { d as defineCustomElement$3 } from './cpc-container-v32.js';
import { d as defineCustomElement$2 } from './cpc-input-number-v22.js';
...
const CpcInputAlpha = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return cpcInputAlphaCss; }
}, [1, "cpc-input-alpha", {
    "value": [1026],
    "containerActive": [32]
  }, [[0, "click", "hanlderClick"]]]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["cpc-input-alpha", "cpc-container-v3", "cpc-input-number-v2", "cpc-input-v1"];
  components.forEach(tagName => { switch (tagName) {
    case "cpc-input-alpha":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CpcInputAlpha);
      }
      break;
...
export { CpcInputAlpha as C, defineCustomElement as d };

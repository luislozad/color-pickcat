...
const CpcInputV1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return cpcInputV1Css; }
}, [1, "cpc-input-v1", {
    "value": [1032],
    "placeholder": [1025],
    "selection": [1028],
...
function defineCustomElement() {
  ...
  const components = ["cpc-input-v1"];
  components.forEach(tagName => { switch (tagName) {
    case "cpc-input-v1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CpcInputV1);
      }
      break;
  } });
}

export { CpcInputV1 as C, defineCustomElement as d };

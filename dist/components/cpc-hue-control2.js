...
const CpcHueControl = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return cpcHueControlCss; }
}, [1, "cpc-hue-control", {
    "value": [1026]
  }]);
function defineCustomElement() {
  ...
  const components = ["cpc-hue-control"];
  components.forEach(tagName => { switch (tagName) {
    case "cpc-hue-control":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CpcHueControl);
      }
      break;
  } });
}

export { CpcHueControl as C, defineCustomElement as d };

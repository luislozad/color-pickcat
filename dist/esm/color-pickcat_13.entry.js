...
const CpcInputColor = class {
  ...
  render() {
    return (h$1(Host, null, h$1("cpc-container-v3", { active: this.containerActive, class: 'flex', onRestoreState: ({ detail }) => this.containerActive = detail.state }, h$1("div", { class: 'w-full pl-2 cursor-text' }, h$1("cpc-input-v1", { selection: this.inputSelection, class: 'text-sm uppercase w-full h-full pb-0.5', value: this.value })), h$1("cpc-menu-v1", { openMenu: this.openMenu, data: [{ items: this.colors }], onItem: ({ detail }) => this.handlerMenuSelection(detail.name), onClick: () => this.handlerOpenMenu() }))));
  }
  handleClick() {
...
export { ColorPickcat as color_pickcat, CpcAlphaControl as cpc_alpha_control, CpcButtonV3 as cpc_button_v3, CpcColorArea as cpc_color_area, CpcContainerV3 as cpc_container_v3, CpcDivisorV1 as cpc_divisor_v1, CpcEyeDropper as cpc_eye_dropper, CpcHueControl as cpc_hue_control, CpcInputColor as cpc_input_color, CpcInputNumberV2 as cpc_input_number_v2, CpcInputV1 as cpc_input_v1, CpcMenuV1 as cpc_menu_v1, CpcPopupV1 as cpc_popup_v1 };

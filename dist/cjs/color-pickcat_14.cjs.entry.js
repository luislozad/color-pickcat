...
const ColorPickcat = class {
  constructor(hostRef) {
    ...
    this.alphaEvent = index.createEvent(this, "alpha", 7);
...
const CpcInputAlpha = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.alphaValueEvent = index.createEvent(this, "alphaValue", 7);
    this.inputAlphaChangeEvent = index.createEvent(this, "inputAlphaChange", 7);
    this.value = 100;
    this.containerActive = false;
  }
  render() {
    return (index.h(index.Host, null, index.h("cpc-container-v3", { active: this.containerActive, onRestoreState: ({ detail }) => this.onContainerActiveRestoreState(detail), class: 'flex' }, index.h("cpc-input-number-v2", { class: 'w-full h-full', value: `${Math.floor(this.value)}%`, onInputChange: ({ detail }) => this.onInputAlphaChangeEvent(detail), onIncrement: () => this.onIncrement(), onDecrement: () => this.onDecrement() }))));
  }
  hanlderClick() {
...
const CpcInputColor = class {
  constructor(hostRef) {
    ...
    this.inputChangeEvent = index.createEvent(this, "inputChange", 7);
    this.colors = [];
    this.value = '#FFFFFF';
    this.containerActive = false;
    this.inputSelection = false;
  ...
  render() {
    return (index.h(index.Host, null, index.h("cpc-container-v3", { active: this.containerActive, class: 'flex', onRestoreState: ({ detail }) => this.containerActive = detail.state }, index.h("div", { class: 'w-full pl-2 cursor-text' }, index.h("cpc-input-v1", { onInputChange: ({ detail }) => this.onInputChange(detail), selection: this.inputSelection, class: 'text-sm uppercase w-full h-full pb-0.5', value: this.value })), index.h("cpc-menu-v1", { openMenu: this.openMenu, data: [{ items: this.colors }], onItem: ({ detail }) => this.handlerMenuSelection(detail.name), onClick: () => this.handlerOpenMenu() }))));
  }
  handleClick() {
...
const CpcInputNumberV2 = class {
  constructor(hostRef) {
    ...
    this.inputChangeEvent = index.createEvent(this, "inputChange", 7);
    this.cleanSelectionEvent = index.createEvent(this, "cleanSelection", 7);
...
exports.cpc_input_alpha = CpcInputAlpha;

...
const index = require('./index-7ac7c99e.js');
...
const ColorPickcat = class {
  constructor(hostRef) {
    ...
    this.colorEvent = index.createEvent(this, "color", 7);
  ...
  render() {
    return (index.h(index.Host, { id: 'clr-picker', class: 'clr-picker' }, index.h("cpc-color-area", { onLoadedComponent: ({ detail }) => this.init(detail.selectedColorDetail), colorMarker: this.colorMarker, colorArea: this.colorArea, handlerPos: this.handlerPos, onSelectedColor: ({ detail }) => this.onSelectedColor(detail) }), index.h("div", { class: 'flex' }, index.h("div", { class: 'space-y-2.5' }, index.h("cpc-hue-control", { value: w(this.colorArea).hue(), class: 'mt-2.5', onHueValue: ({ detail }) => this.onHueValue(detail) }), index.h("cpc-alpha-control", { alpha: this.alphaValue, onAlphaValue: ({ detail }) => this.alphaValue = detail.value, color: this.colorMarker }), index.h("cpc-input-color", { value: this.convertColorType(this.colorType, this.colorMarker), colors: this.colorTypes, onSelectedColor: ({ detail }) => this.colorType = detail.currentColor })), index.h("div", { class: 'ml-2 flex flex-col w-16 space-y-1.5' }, index.h("cpc-eye-dropper", { onGetColor: (e) => this.handlerEyeDropper(e), class: 'mt-2' }), index.h("cpc-container-v3", null, index.h("cpc-input-number-v2", { class: 'pb-0.5', value: `${Math.floor(this.alphaValue)}%`, onIncrement: () => this.alphaValue === 100 ? 100 : this.alphaValue++, onDecrement: () => this.alphaValue === 0 ? 0 : this.alphaValue-- }))))));
  }
  onColorMarker() {
...
const cpcButtonV3Css = "/*! tailwindcss v3.2.4 | MIT License | https://tailwindcss.com*/*,:after,:before{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;border:0 solid #e5e7eb;box-sizing:border-box}html{-webkit-text-size-adjust:100%;font-feature-settings:normal;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;line-height:1.5;-moz-tab-size:4;-o-tab-size:4;tab-size:4}body{line-height:inherit;margin:0}hr{border-top-width:1px;color:inherit;height:0}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{border-collapse:collapse;border-color:inherit;text-indent:0}button,input,optgroup,select,textarea{color:inherit;font-family:inherit;font-size:100%;font-weight:inherit;line-height:inherit;margin:0;padding:0}button,select{text-transform:none}[type=button],[type=reset],[type=submit],button{-webkit-appearance:button;background-color:transparent;background-image:none}:-moz-focusring{outline:auto}:-moz-ui-invalid{box-shadow:none}progress{vertical-align:baseline}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary{display:list-item}blockquote,dd,dl,fieldset,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}fieldset,legend{padding:0}menu,ol,ul{list-style:none;margin:0;padding:0}textarea{resize:vertical}input::placeholder,textarea::placeholder{color:#9ca3af;opacity:1}[role=button],button{cursor:pointer}:disabled{cursor:default}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{height:auto;max-width:100%}[hidden]{display:none}::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }.pointer-events-none{pointer-events:none}.pointer-events-auto{pointer-events:auto}.static{position:static}.mx-1{margin-left:.25rem;margin-right:.25rem}.my-1{margin-bottom:.25rem;margin-top:.25rem}.mt-2{margin-top:.5rem}.ml-2{margin-left:.5rem}.block{display:block}.flex{display:flex}.table{display:table}.hidden{display:none}.h-8{height:2rem}.h-px{height:1px}.h-full{height:100%}.w-px{width:1px}.w-5{width:1.25rem}.w-16{width:4rem}.w-full{width:100%}.grow{flex-grow:1}.cursor-default{cursor:default}.cursor-text{cursor:text}.cursor-pointer{cursor:pointer}.select-none{-webkit-user-select:none;-moz-user-select:none;user-select:none}.select-text{-webkit-user-select:text;-moz-user-select:text;user-select:text}.flex-col{flex-direction:column}.items-center{align-items:center}.justify-start{justify-content:flex-start}.justify-center{justify-content:center}.space-y-2>:not([hidden])~:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.5rem*var(--tw-space-y-reverse));margin-top:calc(.5rem*(1 - var(--tw-space-y-reverse)))}.space-y-1>:not([hidden])~:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.25rem*var(--tw-space-y-reverse));margin-top:calc(.25rem*(1 - var(--tw-space-y-reverse)))}.self-stretch{align-self:stretch}.rounded-md{border-radius:.375rem}.border-0{border-width:0}.bg-transparent{background-color:transparent}.pl-2{padding-left:.5rem}.pb-0{padding-bottom:0}.pr-2{padding-right:.5rem}.text-sm{font-size:.875rem;line-height:1.25rem}.uppercase{text-transform:uppercase}.shadow{--tw-shadow:0 1px 3px 0 rgba(0,0,0,.1),0 1px 2px -1px rgba(0,0,0,.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color),0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.outline-0{outline-width:0}*{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji} /*! tailwindcss v3.2.4 | MIT License | https://tailwindcss.com*/:after,:before{--tw-content:\"\"}blockquote,dd,dl,fieldset,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}input::-moz-placeholder,textarea::-moz-placeholder{color:#9ca3af;opacity:1}.text-\\[13px\\]{font-size:13px}:host{--bg-color:transparent;--bg-color-hover:#09f;--color:#000;--color-hover:#fff;align-items:center;background-color:var(--bg-color);border-radius:.375rem;color:var(--color);cursor:default;display:flex;font-size:13px;justify-content:center;padding:6px 7px 6px 17px}:host(:hover){background-color:var(--bg-color-hover);color:var(--color-hover)}.mt-2\\.5{margin-top:.625rem}.space-y-2\\.5>:not([hidden])~:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.625rem*var(--tw-space-y-reverse));margin-top:calc(.625rem*(1 - var(--tw-space-y-reverse)))}.space-y-1\\.5>:not([hidden])~:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.375rem*var(--tw-space-y-reverse));margin-top:calc(.375rem*(1 - var(--tw-space-y-reverse)))}.pb-0\\.5{padding-bottom:.125rem}.hover\\:bg-\\[\\#eeeeee\\]:hover{--tw-bg-opacity:1;background-color:rgb(238 238 238/var(--tw-bg-opacity))}.active\\:bg-\\[\\#dddddd\\]:active{--tw-bg-opacity:1;background-color:rgb(221 221 221/var(--tw-bg-opacity))}.text-\\[10px\\]{font-size:10px}.text-\\[\\#333333\\]{--tw-text-opacity:1;color:rgb(51 51 51/var(--tw-text-opacity))}.selection\\:bg-transparent ::-moz-selection{background-color:transparent}.selection\\:bg-transparent ::selection{background-color:transparent}.selection\\:bg-transparent::-moz-selection{background-color:transparent}.selection\\:bg-transparent::selection{background-color:transparent}.mx-1\\.5{margin-left:.375rem;margin-right:.375rem}.my-1\\.5{margin-bottom:.375rem;margin-top:.375rem}.w-\\[18px\\]{width:18px}";
...
const CpcColorArea = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.selectedColorEvent = index.createEvent(this, "selectedColor", 7);
    this.loadedComponentEvent = index.createEvent(this, "loadedComponent", 7);
  ...
  render() {
    return (index.h(index.Host, { role: 'application' }, index.h("div", { ref: (ref) => this.refMarker = ref, tabindex: '0' })));
  }
  updateColorAreaDims() {
    this.colorAreaDims = {
...
const CpcContainerV3 = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.restoreStateEvent = index.createEvent(this, "restoreState", 7);
    this.active = false;
  }
  render() {
    const borderActive = this.active ? ({ '--border-color': '#0099ff' }) : undefined;
    return (index.h(index.Host, { style: borderActive }, index.h("slot", null)));
  }
...
const CpcEyeDropper = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.getColorEvent = index.createEvent(this, "getColor", 7);
    this.openEyeDropperEvent = index.createEvent(this, "openEyeDropper", 7);
    this.closeEyeDropperEvent = index.createEvent(this, "closeEyeDropper", 7);
    this.eyeDropper = ('EyeDropper' in window) ? new window.EyeDropper() : undefined;
  }
  render() {
    return (index.h(index.Host, null, index.h("cpc-container-v3", { title: 'Sample Color', class: `flex hover:bg-[#eeeeee] active:bg-[#dddddd]`, tabindex: '0' }, index.h("button", { class: 'flex items-center outline-0	border-0 bg-transparent justify-center w-full h-full', innerHTML: DropperIcon }))));
  }
  async handlerClick() {
    if (this.eyeDropper) {
      try {
...
const CpcHueControl = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.hueValueEvent = index.createEvent(this, "hueValue", 7);
    this.loaded = false;
    this.value = 0;
  }
  render() {
    return (index.h(index.Host, null, index.h("input", { onInput: (e) => this.handlerInput(e), type: 'range', min: '0', max: '360', step: '1', value: this.value }), index.h("div", { id: 'hue-marker-container' }, index.h("div", { ref: (ref) => this.hueMarker = ref, id: 'hue-marker' }))));
  }
  handlerInput(e) {
    const target = e.target;
...
const CpcInputColor = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.selectedColor = index.createEvent(this, "selectedColor", 7);
    this.colors = [];
    this.value = '#FFFFFF';
    this.containerActive = false;
    this.inputSelection = false;
  ...
  render() {
    return (index.h(index.Host, null, index.h("cpc-container-v3", { active: this.containerActive, class: 'flex', onRestoreState: ({ detail }) => this.containerActive = detail.state }, index.h("div", { class: 'w-full pl-2 cursor-text' }, index.h("cpc-input-v1", { selection: this.inputSelection, class: 'text-sm uppercase w-full h-full pb-0.5', value: this.value })), index.h("cpc-menu-v1", { openMenu: this.openMenu, data: [{ items: this.colors }], onItem: ({ detail }) => this.handlerMenuSelection(detail.name), onClick: () => this.handlerOpenMenu() }))));
  }
  handleClick() {
...
const CpcInputNumberV2 = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.incEvent = index.createEvent(this, "increment", 7);
    this.decEvent = index.createEvent(this, "decrement", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("cpc-input-v1", { class: `w-px h-8 grow cursor-text text-[#333333] text-sm`, value: this.value }), this.label && !this.toggle ? (index.h("div", { class: 'text-[10px] uppercase pr-2' }, this.label)) : null, index.h("div", { class: `w-5 flex flex-col self-stretch ${displayControls}` }, index.h("div", { onMouseDown: () => this.incMouseDown(), onMouseUp: () => this.incMouseUp(), class: 'flex cursor-pointer h-px grow justify-center items-center', innerHTML: UpIcon }), index.h("div", { onMouseDown: () => this.decMouseDown(), onMouseUp: () => this.decMouseUp(), class: 'flex cursor-pointer h-px grow justify-center items-center', innerHTML: DownIcon }))));
  }
  incMouseDown() {
...
const CpcInputV1 = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.changeEvent = index.createEvent(this, "inputChange", 7);
    this.selectionEvent = index.createEvent(this, "inputSelection", 7);
    this.cleanSelectionEvent = index.createEvent(this, "inputCleanSelection", 7);
...
const CpcMenuV1 = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.hover = index.createEvent(this, "hover", 7);
    this.item = index.createEvent(this, "item", 7);
    this.data = undefined;
    this.openMenu = false;
  }
  render() {
    ...
    const renderPopupItem = ({ items }, i, arr) => {
      return (index.h("div", { class: 'flex flex-col' }, items.map((value) => (index.h("cpc-button-v3", { class: 'mx-1.5 flex justify-start items-center', onClick: () => handleItem(value) }, value))), i !== (arr.length - 1) ? (index.h("cpc-divisor-v1", { class: 'my-1.5' })) : null));
    };
    return (index.h(index.Host, null, index.h("button", { class: 'flex items-center justify-center w-[18px] h-full', innerHTML: MoreIcon }), openMenu && data ? (index.h("cpc-popup-v1", null, index.h("div", { class: 'flex flex-col' }, data.map(renderPopupItem)))) : null));
  }
  handleHover() {
...
exports.color_pickcat = ColorPickcat;
exports.cpc_alpha_control = CpcAlphaControl;
exports.cpc_button_v3 = CpcButtonV3;
exports.cpc_color_area = CpcColorArea;
exports.cpc_container_v3 = CpcContainerV3;
exports.cpc_divisor_v1 = CpcDivisorV1;
exports.cpc_eye_dropper = CpcEyeDropper;
exports.cpc_hue_control = CpcHueControl;
exports.cpc_input_color = CpcInputColor;
exports.cpc_input_number_v2 = CpcInputNumberV2;
exports.cpc_input_v1 = CpcInputV1;
exports.cpc_menu_v1 = CpcMenuV1;
exports.cpc_popup_v1 = CpcPopupV1;
